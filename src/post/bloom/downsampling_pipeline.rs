use bevy::{
    ...
    render::{
        render_resource::{
            ...
            ShaderType, SpecializedRenderPipeline, SpecializedRenderPipelines, TextureSampleType,
...
#[derive(Component)]
pub struct BloomDownsamplingPipelineId {
...
pub fn prepare_downsampling_pipeline(
    ...
    for (entity, settings) in &views {
        ...
        commands
            .entity(entity)
            .insert(BloomDownsamplingPipelineId {

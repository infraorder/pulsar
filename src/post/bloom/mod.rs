...
use bevy::{
    ...
    render::{
        ...
        render_resource::{
            BindGroup, Extent3d, Sampler, TextureDescriptor, TextureDimension, TextureUsages,
            TextureView,
        },
...
use bevy::{
    ...
    ecs::{component::Component, query::QueryItem, world::World},
    render::{
        ...
        render_resource::{
            ...
            RenderPassDescriptor, Shader, SpecializedRenderPipelines, TextureFormat,
        },
...
use crate::post::bloom::{
    downsampling_pipeline::{
        prepare_downsampling_pipeline, BloomDownsamplingPipeline, BloomUniforms,
    },
    upsampling_pipeline::{prepare_upsampling_pipeline, BloomUpsamplingPipeline},
};

use self::{
    downsampling_pipeline::BloomDownsamplingPipelineId, upsampling_pipeline::UpsamplingPipelineIds,
};
...
impl ViewNode for BloomNode {
    type ViewQuery = (
        ...
        &'static BloomDownsamplingPipelineId,
    );
